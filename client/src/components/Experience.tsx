      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            My professional journey has taken me through various roles where
            I've honed my skills and made meaningful contributions.
          </p>
        </motion.div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="mb-6">
              <h4 className="text-md font-semibold text-textColor mb-3">
                Responsibilities:
              </h4>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {experienceData[activeTab].methodologies.map(
                  (method, index) => (
                    <span
                      key={index}
                      className="px-3 py-1 bg-white rounded-full text-xs text-gray-700 shadow-sm border border-accentColor/20"
                    >
                      {method}
                    </span>
                  ),
