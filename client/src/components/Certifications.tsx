...
export default function Certifications() {
  ...
  return (
    <section
      className="pt-16 pb-20 bg-gray-50 shadow-inner relative"
      id="certifications"
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto">
            Industry qualifications and credentials that validate my expertise
            and knowledge in project management and technical domains.
          </p>
        </motion.div>
          ...
          {featuredCertifications.length > 0 ? (
            ...
            <div className="col-span-3 py-12 text-center">
              <p className="text-lg text-gray-600">
                No certifications found. Certifications will appear here once
                added.
              </p>
              <p className="text-sm text-gray-500 mt-2">
                Total certifications: {certifications.length}, Featured:{" "}
                ...
                onClick={async () => {
                  try {
                    ...
                    if (err instanceof Error) {
                      ...
                      logger.error("Sync error:", String(err));
                    }
                  }
                }}
