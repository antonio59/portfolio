      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row items-center justify-between">
          ...
          <div className="flex flex-col items-center md:items-end">
            ...
            <p className="text-gray-500 text-sm">© {currentYear} John Smith. All rights reserved.</p>
          </div>
        </div>
        
        <div className="mt-8 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
          <div className="text-gray-500 text-sm mb-4 md:mb-0">
            <a href="#" className="hover:text-accentColor transition-colors duration-300 mr-4">Privacy Policy</a>
            <a href="#" className="hover:text-accentColor transition-colors duration-300">Terms of Service</a>
          </div>
