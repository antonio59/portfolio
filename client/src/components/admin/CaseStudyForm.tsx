...
export function CaseStudyForm({ initialData, blogPostId, onSubmit, isSubmitting }: CaseStudyFormProps) {
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input placeholder="e.g., Web Development, Mobile App, Consulting" {...field} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input placeholder="e.g., Project Manager, Lead Developer" {...field} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
