  ...
  return (
    <Card className="w-full">
      <CardHeader>
        ...
        <CardDescription>
          Configure settings for automatically posting new blog content to social media platforms
        </CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
            ...
            <div className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Configure Twitter API credentials to auto-post new blog content
                    </p>
                  </div>
                  <FormField
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="text-lg font-medium flex items-center">
                      <span className="mr-2 h-5 w-5 text-[#0085FF] font-bold">𝕬</span>
                      Bluesky Integration
                    </h3>
                    <p className="text-sm text-muted-foreground">
                      Configure Bluesky credentials to auto-post new blog content
                    </p>
                  </div>
                  <FormField
                    control={form.control}
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          {...field}
                          placeholder="Post format template"
                        />
                      </FormControl>
                      <FormDescription>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        The base URL for blog posts (post slug will be appended to this)
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
