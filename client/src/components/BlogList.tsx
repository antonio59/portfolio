...
import { Search, ChevronRight, ChevronDown, Mail, Share2 } from "lucide-react";
              ...
              <div className="sticky top-8">
                <div className="bg-white rounded-lg shadow-sm border p-6 mb-6">
                  ...
                  <p className="text-gray-600 mb-4">
                    I write about my experiences building and maintaining
                    self-hosted applications, projects I'm working on, and
                    technology insights.
                  </p>
