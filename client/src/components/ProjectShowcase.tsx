...
const projectsData: ProjectItem[] = [
  // Professional Project Management Projects
  {
    ...
    description:
      "Led a cross-functional team to implement a company-wide digital transformation initiative, modernizing legacy systems and introducing new technologies to improve operational efficiency.",
    image:
  ...
  },
  {
    ...
    description:
      "Managed the migration of a critical healthcare management system serving 18 regional hospitals, ensuring data integrity and compliance with regulatory requirements.",
    image:
      "https://images.unsplash.com/photo-1551076805-e1869033e561?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80",
  ...
  },
  {
    ...
    description:
      "Directed the development and launch of a next-generation financial services platform serving over 500,000 customers with strict security and compliance requirements.",
    image:
  ...
  // Personal Hobby Projects
  {
    ...
    description:
      "A beautifully designed weather application that provides real-time weather data visualization with animated transitions and intuitive user interface.",
    image:
  ...
  },
  {
    ...
    description:
      "A mobile application that allows users to find recipes based on ingredients they already have, with filtering options for dietary restrictions and cooking time.",
    image:
      "https://images.unsplash.com/photo-1505935428862-770b6f24f629?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1167&q=80",
  ...
  },
  {
    ...
    description:
      "A comprehensive fitness tracking dashboard that integrates with wearable devices to provide personalized workout statistics and progress visualization.",
    image:
      "https://images.unsplash.com/photo-1632781297772-1d68f375d878?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1074&q=80",
      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="text-lg text-gray-600">
            A showcase of my professional project management experience and
            ...
            {professionalProjects.map((project, index) => (
              ...
              >
                <div className="w-full lg:w-7/12 overflow-hidden rounded-lg shadow-lg">
                  ...
                  >
                    <div className="absolute inset-0 bg-accentColor/80 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center z-10">
                      <a
                        href={project.link}
                        className="px-6 py-3 bg-white text-accentColor font-medium rounded-md hover:bg-gray-100 transition-colors duration-300"
                      >
                        View Project
                      </a>
                    </div>
                ...
                <div className="w-full lg:w-5/12">
                  ...
                  <h3 className="text-2xl md:text-3xl font-bold mt-2 mb-4 text-textColor">
                    {project.title}
                  </h3>
                  ...
                  <div className="bg-secondaryBg p-6 rounded-lg shadow-md mb-6">
                    ...
                    {project.role && (
                      <p className="text-accentColor font-medium">
                        Role: {project.role}
                      </p>
                    )}
                  </div>
                      ...
                      >
                        {project.challenges &&
                          project.challenges.length > 0 && (
                            <div className="mb-4">
                              <h4 className="font-bold text-textColor mb-2">
                                Key Challenges:
                              </h4>
                  ...
                  <div className="flex gap-4">
                    <a
                      href={project.link}
                      className="text-gray-700 hover:text-accentColor transition-colors"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
