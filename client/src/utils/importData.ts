...
const sampleProjects: ImportableProject[] = [
  {
    ...
    description:
      "A complete redesign of a professional portfolio website with modern UI/UX principles. Features responsive design, dynamic content loading, and a custom CMS for content management.",
    ...
    challenges: [
      ...
      "Creating a performant image loading system",
  ...
  },
  {
    ...
    description:
      "Enterprise-level project management dashboard with real-time analytics, team collaboration features, and customizable workflows for different project types.",
    category: "professional",
    technologies: [
      "React",
      "Redux",
    ...
    challenges: [
      ...
      "Creating a customizable workflow engine",
    ],
    outcomes: [
      "Reduced project reporting time by 65%",
      "Improved team collaboration metrics",
      "Successful deployment to 5 enterprise clients",
    ],
  ...
  },
  {
    ...
    description:
      "A comprehensive team collaboration platform with features like task management, file sharing, chat, video conferencing, and calendar integration.",
    category: "professional",
    technologies: [
      "Angular",
      "TypeScript",
    ...
    icon: "users",
    challenges: [
      "Building reliable video conferencing features",
      "Implementing secure document sharing",
      "Creating an intuitive UX for diverse user types",
    ],
    outcomes: [
      "98.5% uptime for communication services",
      "Secured HIPAA compliance certification",
      "Positive user satisfaction ratings (4.8/5)",
    ],
  ...
  },
  {
    ...
    description:
      "A hobby project that provides detailed weather forecasts with interactive maps, hourly predictions, and severe weather alerts.",
    category: "hobby",
  ...
  },
  {
    title: "Recipe Finder",
    description:
      "A personal project for finding recipes based on available ingredients, dietary restrictions, and cooking time. Includes meal planning and grocery list features.",
    category: "hobby",
...
const sampleSections: ImportableSection[] = [
  ...
  },
  {
    ...
    content: [
      "I'm always interested in hearing about new projects and opportunities. Whether you're looking for a project manager to join your team or just want to connect, feel free to reach out!",
    ],
    type: "contact",
  },
  {
    ...
    content: [
      "I'm Antonio Smith, a Project Manager specializing in tech and digital transformation. With a focus on delivering excellence, I help teams build innovative solutions that drive business success.",
    ],
    type: "hero",
  },
];
...
export async function importProjects() {
  try {
    ...
    return {
      ...
      message: `Successfully imported ${results.length} projects.`,
    };
  } catch (error) {
...
export async function importExperiences() {
  try {
    ...
    return {
      success: true,
      count: results.length,
      message: `Successfully imported ${results.length} experiences.`,
    };
  } catch (error) {
...
export async function importSections() {
  try {
    ...
    return {
      success: true,
      count: results.length,
      message: `Successfully imported ${results.length} sections.`,
    };
  } catch (error) {
