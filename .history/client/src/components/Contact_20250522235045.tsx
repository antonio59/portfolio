...
export default function Contact() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      logger.info('Contact form submitted successfully:', result);
      ...
      logger.error('Error submitting contact form:', errorMessage);
  ...
  return (
    <section
      id="contact"
      className="py-20 bg-primaryBg shadow-lg border-t border-gray-200 relative"
    >
