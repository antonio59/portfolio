  ...
  categoryId: z
    .union([
      z
        .string()
        .transform((val) =>
          val === "null" ? null : val ? parseInt(val) : null,
        ),
      z.number().nullable(),
    ])
    .nullable()
    ...
    <Card className="w-full">
            ...
            {activeTab === "posts" ? (
              <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
                ...
                <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
                  ...
                  <Form {...postForm}>
                    <form
                      onSubmit={postForm.handleSubmit(onSubmitAddPost)}
                      className="space-y-4"
                    >
                            ...
                            <AlertDialog>
                              ...
                              <AlertDialogContent>
                                <AlertDialogHeader>
                                  ...
                                  <AlertDialogDescription>
                                    Are you sure you want to delete "
                                    {category.name}"? Posts in this category
                                    will not be deleted but will be
                                    uncategorized.
                                  </AlertDialogDescription>
                                </AlertDialogHeader>
                                <AlertDialogFooter>
      ...
      <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          ...
          <Form {...postForm}>
            <form
              onSubmit={postForm.handleSubmit(onSubmitEditPost)}
              className="space-y-4"
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <FormField
