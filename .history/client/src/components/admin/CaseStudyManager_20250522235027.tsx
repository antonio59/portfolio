...
// Update the form schema to match the CaseStudyDetail interface
const options = () => {
  // Example usage of options
   

  console.info('Using options');
};

const formSchema = () => {
  // Example usage of formSchema
   

  console.info('Using formSchema');
};

const FormValues = () => {
  // Example usage of FormValues
   

  console.info('Using FormValues');
};
