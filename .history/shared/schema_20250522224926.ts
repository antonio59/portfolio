...
export type InsertBlogPost = Inserts<'blog_posts'>
export type UpdateBlogPost = Updates<'blog_posts'>

export type CaseStudyDetail = Tables<'case_study_details'>
export type InsertCaseStudyDetail = Inserts<'case_study_details'>
export type UpdateCaseStudyDetail = Updates<'case_study_details'>

export type ContactSubmission = Tables<'contact_submissions'>
export type InsertContactSubmission = Inserts<'contact_submissions'>
export type UpdateContactSubmission = Updates<'contact_submissions'>
